...
namespace Mandelbrot
{
    public class InvoerForm : Form
    {
        ...
        public InvoerForm()
        {
            ...
            listbox.Size = new Size(80, 60);
            listbox.Location = new Point(370, 13);
            listbox.Items.Add("start");
            listbox.Items.Add("uiteenlopend");
            listbox.Items.Add("vertakking");
            listbox.Items.Add("poppetjes");
        ...
        public void Button_Click(object sender, EventArgs e)
        {
            ...
            // Try catch zodat alleen getallen worden geaccepteerd
            try
            {
        ...
        public void listboxClick(object sender, MouseEventArgs e)
        {
            ...
            // Switch case is voor de vier basisplaatjes
            switch (keuze)
            {
                case 0:
                    verschuivingX = 0;
        ...
        public void drawingPoint(object sender, PaintEventArgs e)
        {
            ...
            for (float x = 0; x < display.Width; x++)
            {
                for (float y = 0; y < display.Height; y++)
                {
                    ...
                    // For-loop voor berekening mandelgetal int i
                    int i;
                    for (i = 0; i < max; i++)
                    {
